...
const { getStudentApplications, getRecruiterApplications, getJobApplications, updateApplicationStatus, manualApply, deleteApplication } = require('../controllers/applicationController');
